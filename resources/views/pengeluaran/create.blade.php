                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control currency" id="pengeluaran" name="pengeluaran"
                                        value="{{ old('pengeluaran') }}" placeholder="Berapa Jumlah Pengeluaran" onkeyup="formatInput(this)">
                                </div>
