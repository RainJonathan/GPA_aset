                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <table class="table border">
                                            ...
                                            <tr>
                                                <th>Status</th>
                                                <td>{{ $asset->tuanRumah ? ($asset->tuanRumah->aktif === 0 ? 'Tidak Aktif' : 'Aktif') : '-' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Pengeluaran</th>
                                ...
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $asset->tuanRumah ? 'Rp. ' . number_format($asset->hostlatest->harga_sewa, 2, ',', '.') : '-' }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                                ...
                                                <tbody>
                                                    @foreach ($asset->previousOwners as $previousOwner)
                                                        <tr>
                                                            ...
                                                            <td>Rp
                                                                {{ number_format($previousOwner->harga_sewa, 0, ',', '.') }}
                                                            </td>
                                                            <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $previousOwner->tgl_awal)->format('d-m-Y') }}
                                                            </td>
                                                            <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $previousOwner->tgl_akhir)->format('d-m-Y') }}
                                                            </td>
                                                            <td>Rp
                                                                {{ number_format($previousOwner->upah_jasa + $previousOwner->harga_sewa, 0, ',', '.') }}
                                                            </td>
                                                            <td>{{ $previousOwner->saldo_piutang == 0 ? 'Tidak Lunas' : 'Lunas' }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
